...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setReapplyLabel(label) {
        forceReapplyBtn.replaceChildren();
        const svgDoc = new DOMParser().parseFromString(_REAPPLY_SVG, 'image/svg+xml');
        forceReapplyBtn.appendChild(document.adoptNode(svgDoc.documentElement));
        forceReapplyBtn.appendChild(document.createTextNode(' ' + label));
    }
    ...
    function setFixTextLabel(label) {
        fixTextBtn.replaceChildren();
        const svgDoc = new DOMParser().parseFromString(_FIX_TEXT_SVG, 'image/svg+xml');
        fixTextBtn.appendChild(document.adoptNode(svgDoc.documentElement));
        fixTextBtn.appendChild(document.createTextNode(' ' + label));
    }
